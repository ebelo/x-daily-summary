...
- **Shell Command Standards**: *Warning:* Always refer to the [Shell Command Standards skill](file:///c:/Users/emman/Antigravity-data/x_daily_summary/.agents/skills/shell-command-standards/SKILL.md) before chaining commands in a terminal.
